    ...
    // - basic
    {
...

      {
        ...
        // various other display options
        {
          ...
          choice_bfi = CreateChoice(page_general, Config::GFX_USE_BLACK_FRAME_INSERTION, (bfi_desc),
