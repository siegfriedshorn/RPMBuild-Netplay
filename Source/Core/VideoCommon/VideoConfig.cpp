...
void VideoConfig::Refresh()
{
  ...
  iBlackFrameInsertion = Config::Get(Config::GFX_USE_BLACK_FRAME_INSERTION);
  iBlackFrameInsertionBIR = Config::Get(Config::GFX_USE_BLACK_FRAME_BIR);
  ...
  bShowOSDClock = Config::Get(Config::GFX_SHOW_OSD_CLOCK);
  bShowFrameTimes = Config::Get(Config::GFX_SHOW_FRAME_TIMES);
